...
const Home = () => {
  return (
    <header className='flex flex-col items-center h-screen sm:h-[68vh] lg:h-screen w-11/12 lg:w-10/12 max-w-5xl overflow-hidden pt-28 text-center my-0 mx-auto font-medium relative home'>
      <h5 className='text-lg mb-4'>Olá! Eu sou</h5>
      ...
      <span className="hidden sm:inline-block absolute right-[-2.2rem] bottom-20 rotate-90 text-primary hover:text-white font-extralight text-md transition-colors duration-[400ms]"><Link to="contact" spy={true} smooth={true} offset={-80} duration={50}>Scroll Down</Link></span>
    </header >
  )
}
